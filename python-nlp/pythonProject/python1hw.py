...
for token in oceanlyrics:
    # if token.pos_ == "VERB":
    print(token.text, "---->", token.pos_, ":::::", token.lemma_, token.shape_, ";;;;;;;") #what do the arrows and semicolons do? I assumed they were to accuratly find the function they were associated with but I think I ended up breaking it by adding my own bits
